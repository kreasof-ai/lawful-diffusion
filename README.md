...
2. [1. Data Preparation](#1-data-preparation)
3. [2. Load Pretrained Models](#2-load-pretrained-models)
4. [3. Extract and Combine Embeddings](#3-extract-and-combine-embeddings)
5. [4. Encode Labels](#4-encode-labels)
6. [5. Create Dataset and DataLoader](#5-create-dataset-and-dataloader)
7. [6. Define the Classification Model](#6-define-the-classification-model)
8. [7. Train the Model](#7-train-the-model)
9. [8. Save and Load the Trained Model](#8-save-and-load-the-trained-model)
10. [9. Integrate with Image Generation Pipeline](#9-integrate-with-image-generation-pipeline)
11. [10. External Image Verification Enhancement](#10-external-image-verification-enhancement)
